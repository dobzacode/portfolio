...
export default function HomePage({}) {
  const [extraDelay] = useState<4.3 | 1>(!sessionStorage.getItem('corentin') ? 4.3 : 1);
  ...
  console.log(5.3 + splashDelay - (extraDelay - 1));
  ...
  return (
    <>
      ...
      ></Header>
      <main
        className={`relative flex h-[80vh] w-screen flex-col items-center justify-center duration-slow ${
        ...
        <div className="relative -z-10">
          <motion.p
            ...
            animate={{
              ...
              rotate: '-17deg',
              transition: {
                delay: 3.0 + extraDelay + splashDelay,
                type: 'spring',
                stiffness: '40'
              }
            }}
          ...
          <div className="overflow-hidden ">
            <motion.img
              ...
              animate={{
                y: '0px',
                transition: {
                  delay: 2.3 + extraDelay + splashDelay,
                  type: 'spring',
                  stiffness: '40'
                }
              }}
            ...
            <motion.hr
              ...
              animate={{
                ...
                transition: { type: easeOut, delay: 2 + extraDelay + splashDelay }
              }}
              exit={{ maxWidth: 0, transition: { type: easeOut, delay: 1, duration: 0.5 + 2 } }}
              className=" absolute bottom-0 z-40  box-content  w-full  border-tertiary40"
            ></motion.hr>
          </div>
        </div>

        <div className="relative flex flex-col items-center justify-center gap-medium bg-primary1  duration-medium dark:bg-primary99">
          <motion.div
            key="text"
            ...
            animate={{
              ...
              transition: {
                delay: 3.6 + extraDelay + splashDelay,
                type: 'spring',
                stiffness: '40'
              }
            }}
          ...
          <div className="relative   flex justify-between gap-large">
            <motion.div
              ...
              animate={{
                ...
                transition: {
                  type: 'spring',
                  delay: 4.5 + splashDelay + extraDelay
                }
              }}
            ...
            <motion.div
              ...
              animate={{
                ...
                transition: {
                  type: 'spring',
                  delay: 4.8 + splashDelay + extraDelay
                }
              }}
              exit={{ y: '100px', opacity: 0, transition: { delay: 2 } }}
              className="relative   flex items-center gap-extra-small text-tertiary90 dark:text-tertiary1 "
