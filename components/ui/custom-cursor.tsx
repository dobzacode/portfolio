...
export default function CustomCursor() {
  ...
  return (
    <div
      className="cursor absolute -z-[500] flex h-20 w-20 cursor-none items-center justify-center rounded-full after:absolute  after:-left-4 after:-top-4 after:h-10 after:w-10 after:rounded-full after:border-2 after:border-tertiary40 after:opacity-50 max-laptop:hidden"
      ref={cursorRef}
    >
